...
from ..sampling import (seek_float, ShiftAndResample, Resample,
                        TimeDelay, DelayAndResample)
from ..base import Task, SetAttribute
from ..channelize import Channelize
from ..combining import Stack
from ..generators import EmptyStreamGenerator, StreamGenerator, Noise
...
class TestResampleReal:
    ...
    def test_shift_and_resample(self, shift, offset):
        # Offsets and means must be equal to integer samples in full_fh
        # (so quarter samples in part_fh) to allow check.
